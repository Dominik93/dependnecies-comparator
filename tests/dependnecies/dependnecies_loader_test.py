...
class DependenciesLoaderTestCase(unittest.TestCase):
    ...
    def test_read_dependencies_from_files(self):
        ...
        expected = [
            Dependency("sample-one", "com.sample.one", "sample-one-one", "2.4.0", "runtime"),
            Dependency("sample-one", "com.sample.one", "sample-one-two", "2.0.0", "runtime"),
            Dependency("sample-two", "com.sample.two", "sample-two-one", "4.3.2", "runtime"),
            Dependency("sample-two", "com.sample.two", "sample-two-two", "4.3.2", "runtime"),
            Dependency("sample-two", "com.sample.two", "sample-two-three", "4.3.2", "runtime")
        ]
        self.assertEqual(actual, expected)
